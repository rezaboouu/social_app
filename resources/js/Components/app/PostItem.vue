...
function deletePost(){
    if (window.confirm('ایا از پاک کردن پست خود اطمینان دارید؟')) {
    ...
    <div class="bg-white border rounded p-4 mb-3">
        <div class="flex items-center justify-between mb-3">
            ...
            <Menu as="div" class="relative z-10 inline-block text-left">
                ...
                >
                    <MenuItems
                        class="absolute   mt-2 w-32 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none"
                      style="right: -99px;">
                        <div class="px-1 py-1">
        ...
        <div class="grid gap-3 mb-3" :class="[
            ...
            <template v-for="(attachment, ind) of post.attachments.slice(0, 4)">
                <div @click="openAttachment(ind)"
                     class="group cursor-pointer aspect-square bg-blue-100 flex flex-col items-center justify-center text-gray-500 relative">
